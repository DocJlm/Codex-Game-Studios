...
- [ ] `tool expectations:` list matches the agent's role (Read, Write for UE project files; no deployment tools)
...
## Coverage Notes
- No automated runner exists for agent behavior tests — these are reviewed manually or via `$cgs-skill-test`
