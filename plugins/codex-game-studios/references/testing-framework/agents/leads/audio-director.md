...
Verified by reading the agent's `plugins/codex-game-studios/references/role-cards/audio-director.md` frontmatter:
...
- [ ] `tool expectations:` list is read-focused; no Bash unless audio asset pipeline checks are justified
