...
- [ ] Frontmatter has all required fields (`name`, `description`, `usage note`, `Codex-discoverable`, `tool expectations`)
- [ ] 2+ phase headings found
- [ ] At least one verdict keyword present (`PASS`, `FAIL`, `CONCERNS`, `APPROVED`, `BLOCKED`, `COMPLETE`, `READY`)
- [ ] If `tool expectations` includes Write/Edit: `"May I write"` language present
