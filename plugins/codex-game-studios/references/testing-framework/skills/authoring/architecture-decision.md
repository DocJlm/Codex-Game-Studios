# Skill Test Spec: $cgs-architecture-decision

## Skill Summary

`$cgs-architecture-decision` guides the user through section-by-section authoring of
...
**Input:** `$cgs-architecture-decision rendering-approach`
...
**Input:** `$cgs-architecture-decision [topic]`
...
**Input:** `$cgs-architecture-decision [same-topic]`
