# Skill Test Spec: $cgs-design-system

## Skill Summary

`$cgs-design-system` guides the user through section-by-section authoring of a Game
...
**Input:** `$cgs-design-system [system-name]`
...
- [ ] Ends with next-step handoff: `$cgs-review-all-gdds` or `$cgs-map-systems next`
