# Skill Test Spec: $cgs-art-bible

## Skill Summary

`$cgs-art-bible` is a guided, section-by-section art bible authoring skill. It
...
- [ ] Has a next-step handoff (e.g., `$cgs-asset-spec` or `$cgs-design-system`)
...
- The art bible feeds into `$cgs-asset-spec` — this relationship is noted in the
