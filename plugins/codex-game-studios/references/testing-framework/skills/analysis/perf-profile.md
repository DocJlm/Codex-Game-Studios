# Skill Test Spec: $cgs-perf-profile

## Skill Summary

`$cgs-perf-profile` is a structured performance profiling workflow that identifies
...
**Input:** `$cgs-perf-profile production/qa/profiler-export-2026-03-15.json`
...
**Fixture:**
- User runs `$cgs-perf-profile` with no arguments
- No profiler data files exist in `production/qa/`

**Input:** `$cgs-perf-profile`
...
**Input:** `$cgs-perf-profile production/qa/profiler-export-2026-03-20.json`
...
**Input:** `$cgs-perf-profile production/qa/profiler-export-2026-04-05.json`
...
**Input:** `$cgs-perf-profile production/qa/profiler-export-2026-04-01.json`

**Expected behavior:**
1. Skill analyzes profiler data; verdict is CONCERNS
2. No director gate is invoked regardless of review mode
3. Output notes: "For in-depth analysis, consider running `$cgs-perf-profile` with the performance-analyst agent"
