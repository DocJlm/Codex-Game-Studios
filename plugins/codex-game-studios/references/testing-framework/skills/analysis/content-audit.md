# Skill Test Spec: $cgs-content-audit

## Skill Summary

`$cgs-content-audit` reads GDDs in `design/gdd/` and checks whether all content
...
2. Skill outputs: "No content specifications found in GDDs — run $cgs-design-system first to define content lists"
...
- [ ] Output recommends running `$cgs-design-system`
