# Skill Test Spec: $cgs-scope-check

## Skill Summary

`$cgs-scope-check` is a Haiku-tier read-only skill that analyzes a feature, sprint,
...
- [ ] Output suggests running `$cgs-milestone-review` or creating a milestone
...
**Input:** `$cgs-scope-check production/epics/combat/story-parry-timing.md`
