# Skill Test Spec: $cgs-balance-check

## Skill Summary

`$cgs-balance-check` reads balance data files (JSON or YAML in `assets/data/`) and
...
3. Skill outputs: "Cannot validate economy stats — no formulas defined. Run $cgs-design-system first."
...
- [ ] Output recommends running `$cgs-design-system` to define formulas
