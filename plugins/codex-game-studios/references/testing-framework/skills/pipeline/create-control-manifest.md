# Skill Test Spec: $cgs-create-control-manifest

## Skill Summary

`$cgs-create-control-manifest` reads all Accepted ADRs from `docs/architecture/` and
...
- [ ] Has a next-step handoff at the end (`$cgs-create-epics` or `$cgs-create-stories`)
...
**Input:** `$cgs-create-control-manifest`
...
2. Skill outputs: "No ADRs found. Run `$cgs-architecture-decision` to create ADRs before generating the control manifest."
...
- [ ] Ends with next-step handoff: `$cgs-create-epics` or `$cgs-create-stories`
