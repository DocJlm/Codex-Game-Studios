# Skill Test Spec: $cgs-create-epics

## Skill Summary

`$cgs-create-epics` reads all approved GDDs and translates them into EPIC.md files,
...
- [ ] Has a next-step handoff at the end (`$cgs-create-stories`)
...
4. Skill suggests running `$cgs-design-system` and completing GDD approval first
...
- [ ] Ends with next-step handoff: `$cgs-create-stories [epic-slug]` per created epic
