# Skill Test Spec: $cgs-propagate-design-change

## Skill Summary

`$cgs-propagate-design-change` handles GDD revision cascades. When a GDD is updated,
...
**Input:** `$cgs-propagate-design-change design/gdd/[system].md`
...
**Input:** `$cgs-propagate-design-change` (no argument)

**Expected behavior:**
1. Skill detects no argument is provided
2. Skill outputs a usage error: "No GDD specified. Usage: $cgs-propagate-design-change design/gdd/[system].md"
