# Skill Test Spec: $cgs-dev-story

## Skill Summary

`$cgs-dev-story` reads a story file, loads all required context (referenced ADR,
...
- [ ] Has a next-step handoff at the end (`$cgs-story-done`)
...
- `plugins/codex-game-studios/references/studio-docs/technical-preferences.md` has engine and language configured
- `production/session-state/review-mode.txt` contains `full`

**Input:** `$cgs-dev-story production/epics/[layer]/story-[name].md`
...
5. Skill recommends running `$cgs-architecture-decision` to advance the ADR
...
- [ ] Skill recommends `$cgs-architecture-decision` as the next action
...
**Input:** `$cgs-dev-story` (no argument)
...
- [ ] Ends with next-step handoff: `$cgs-story-done`
