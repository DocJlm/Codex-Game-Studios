# Skill Test Spec: $cgs-asset-spec

## Skill Summary

`$cgs-asset-spec` generates per-asset visual specification documents from design
...
- [ ] Has a next-step handoff (e.g., assign to an artist, or `$cgs-asset-audit` later)

---

## Director Gate Checks

None. `$cgs-asset-spec` is a design documentation utility. Technical artists may
...
**Input:** `$cgs-asset-spec goblin-enemy`
...
**Input:** `$cgs-asset-spec player-sprite`
...
**Input:** `$cgs-asset-spec goblin-enemy orc-enemy treasure-chest`
