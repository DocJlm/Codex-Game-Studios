# Skill Test Spec: $cgs-soak-test

## Skill Summary

`$cgs-soak-test` generates a structured soak test protocol — an extended runtime
...
- [ ] Has a next-step handoff (e.g., `$cgs-regression-suite` or `$cgs-release-checklist`)

---

## Director Gate Checks

None. `$cgs-soak-test` is a QA planning utility. No director gates apply.
...
**Input:** `$cgs-soak-test online-lobby 2h`
...
**Input:** `$cgs-soak-test online-lobby 4h`
...
**Input:** `$cgs-soak-test gameplay 30m`
