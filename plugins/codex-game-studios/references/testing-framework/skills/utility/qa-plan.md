# Skill Test Spec: $cgs-qa-plan

## Skill Summary

`$cgs-qa-plan` generates a structured QA test plan for a feature or sprint milestone.
...
- [ ] Has a next-step handoff (e.g., `$cgs-smoke-check` or `$cgs-story-readiness`)

---

## Director Gate Checks

None. `$cgs-qa-plan` is a planning utility. Story readiness gates are separate.
