# Skill Test Spec: $cgs-launch-checklist

## Skill Summary

`$cgs-launch-checklist` generates and evaluates a complete launch readiness checklist
...
director gates apply — `$cgs-team-release` orchestrates the full release pipeline. Verdicts:
...
- [ ] Has a next-step handoff (e.g., `$cgs-team-release` or `$cgs-day-one-patch`)

---

## Director Gate Checks

None. `$cgs-launch-checklist` is a readiness audit utility. The full release pipeline
is managed by `$cgs-team-release`.
