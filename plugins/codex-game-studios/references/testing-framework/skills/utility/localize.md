# Skill Test Spec: $cgs-localize

## Skill Summary

`$cgs-localize` manages the full localization pipeline: it extracts all player-facing
...
None. `$cgs-localize` is a pipeline utility. No director gates apply. Localization
...
5. Skill suggests fixing the file manually and re-running `$cgs-localize`
