# Skill Test Spec: $cgs-skill-improve

## Skill Summary

`$cgs-skill-improve` runs an automated test-fix-retest improvement loop on a skill
file. It invokes `$cgs-skill-test static` (and optionally `$cgs-skill-test category`) to
...
- [ ] Has a next-step handoff (e.g., run `$cgs-skill-test spec` to validate behavioral compliance)

---

## Director Gate Checks

None. `$cgs-skill-improve` is a meta-utility skill. No director gates apply.
...
**Fixture:**
- `plugins/codex-game-studios/skills/some-skill/SKILL.md` has 2 static failures:
  - Check 4: no "May I write" language despite having Write in tool expectations
  - Check 5: no next-step handoff at the end

**Input:** `$cgs-skill-improve some-skill`

**Expected behavior:**
1. Skill runs `$cgs-skill-test static some-skill` — baseline: 5/7 checks pass
...
4. Skill asks "May I write improvements to `plugins/codex-game-studios/skills/some-skill/SKILL.md`?"
5. Fixes applied; `$cgs-skill-test static some-skill` re-run — now 7/7 checks pass
...
**Fixture:**
- `plugins/codex-game-studios/skills/some-skill/SKILL.md` has 1 static failure (missing handoff)
...
**Fixture:**
- `plugins/codex-game-studios/skills/gate-check/SKILL.md` is a gate skill with 1 static failure
  and 2 category (G-criteria) failures
- `tests/skills/quality-rubric.md` has Gate Skills section

**Input:** `$cgs-skill-improve gate-check`
...
4. "May I write improvements to `plugins/codex-game-studios/skills/gate-check/SKILL.md`?"
...
**Fixture:**
- `plugins/codex-game-studios/skills/brainstorm/SKILL.md` has no static failures
- Category score is also 5/5 (if applicable)

**Input:** `$cgs-skill-improve brainstorm`

**Expected behavior:**
1. Skill runs `$cgs-skill-test static brainstorm` — 7/7 checks pass
...
- The improvement loop is designed to run only one fix-retest cycle per
  invocation; running multiple iterations requires re-invoking `$cgs-skill-improve`.
