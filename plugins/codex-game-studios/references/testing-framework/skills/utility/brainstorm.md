# Skill Test Spec: $cgs-brainstorm

## Skill Summary

`$cgs-brainstorm` facilitates guided game concept ideation. It presents 2-4 concept
...
- [ ] Has a next-step handoff at the end (`$cgs-map-systems`)
...
- [ ] Next-step handoff to `$cgs-map-systems` is present
...
- [ ] Ends with next-step handoff: `$cgs-map-systems`
