# Skill Test Spec: $cgs-skill-test

## Skill Summary

`$cgs-skill-test` validates skill files for structural correctness, behavioral
...
- **audit**: Produces a coverage table of all skills in `plugins/codex-game-studios/skills/` and
  all agents in `plugins/codex-game-studios/references/role-cards/`, showing which have spec files and which do not.
...
- [ ] Has a next-step handoff (e.g., `$cgs-skill-improve` to fix issues found)

---

## Director Gate Checks

None. `$cgs-skill-test` is a meta-utility skill. No director gates apply.
...
**Fixture:**
- `plugins/codex-game-studios/skills/brainstorm/SKILL.md` exists and is well-formed:
...
**Input:** `$cgs-skill-test static brainstorm`

**Expected behavior:**
1. Skill reads `plugins/codex-game-studios/skills/brainstorm/SKILL.md`
...
### Case 2: Static Mode — Skill Missing "May I Write" Despite Write Tool in tool expectations

**Fixture:**
- `plugins/codex-game-studios/skills/some-skill/SKILL.md` has `Write` in `tool expectations` frontmatter
- The skill body has no "May I write" or "May I update" language

**Input:** `$cgs-skill-test static some-skill`

**Expected behavior:**
1. Skill reads `some-skill/SKILL.md`
2. Check 4 (collaborative write protocol) fails: `Write` in tool expectations but no
...
- `plugins/codex-game-studios/skills/gate-check/SKILL.md` exists

**Input:** `$cgs-skill-test spec gate-check`
...
**Fixture:**
- `plugins/codex-game-studios/skills/` contains 72+ skill directories
- `plugins/codex-game-studios/references/role-cards/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `$cgs-skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `plugins/codex-game-studios/skills/` and all agents in `plugins/codex-game-studios/references/role-cards/`
...
- `plugins/codex-game-studios/skills/gate-check/SKILL.md` is a gate skill

**Input:** `$cgs-skill-test category gate-check`
...
- [ ] Suggests `$cgs-skill-improve` as the next step when issues are found
