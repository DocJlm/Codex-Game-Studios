# Skill Test Spec: $cgs-story-readiness

## Skill Summary

`$cgs-story-readiness` validates that a story file is ready for a developer to
...
**Input:** `$cgs-story-readiness production/epics/core/story-light-pickup.md`
...
**Input:** `$cgs-story-readiness production/epics/core/story-light-system.md`
...
**Input:** `$cgs-story-readiness production/epics/core/story-oxygen-drain.md`
...
**Input:** `$cgs-story-readiness production/epics/core/story-mirror-rotation.md`
...
**Input:** `$cgs-story-readiness production/epics/core/story-light-pickup.md` (full mode)
