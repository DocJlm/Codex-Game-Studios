# Skill Test Spec: $cgs-story-done

## Skill Summary

`$cgs-story-done` closes the loop between design and implementation. Run at the
...
**Input:** `$cgs-story-done production/epics/core/story-light-pickup.md`
...
**Input:** `$cgs-story-done` (no argument)
...
**Input:** `$cgs-story-done production/epics/core/story-light-pickup.md` (full mode)
