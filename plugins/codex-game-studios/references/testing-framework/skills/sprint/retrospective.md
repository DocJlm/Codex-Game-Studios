# Skill Test Spec: $cgs-retrospective

## Skill Summary

`$cgs-retrospective` generates a structured sprint or milestone retrospective
...
**Input:** `$cgs-retrospective sprint-005`
...
- User re-runs `$cgs-retrospective sprint-005` after changes
...
- User runs `$cgs-retrospective sprint-005`
