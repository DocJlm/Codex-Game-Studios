# Skill Test Spec: $cgs-milestone-review

## Skill Summary

`$cgs-milestone-review` generates a comprehensive review of a completed milestone:
...
**Input:** `$cgs-milestone-review milestone-03`
...
**Fixture:**
- User calls `$cgs-milestone-review milestone-07`
- `production/milestones/milestone-07.md` does NOT exist

**Input:** `$cgs-milestone-review milestone-07`
