...
**Next steps:**
1. `$cgs-design-review design/gdd/game-concept.md`
2. `$cgs-gate-check`
3. `$cgs-map-systems`
4. `$cgs-design-system [mechanic]` (use learnings in Tuning Knobs and Formulas sections)
...
**Next step:** `$cgs-prototype [revised-concept]`
...
**Next step:** `$cgs-brainstorm [new-direction]`
