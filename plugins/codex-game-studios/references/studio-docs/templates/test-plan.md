...
Critical paths to verify before QA hand-off (run via `$cgs-smoke-check`):
...
*Results and sign-off are tracked in the QA sign-off report generated by `$cgs-team-qa` — not in this plan file.*

*Template: `plugins/codex-game-studios/assets/templates/test-plan.md`*
*Generated by: `$cgs-qa-plan` — do not edit this line*
