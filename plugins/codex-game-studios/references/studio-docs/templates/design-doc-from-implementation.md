...
- Run `$cgs-balance-check` on [specific aspect]
...
- [ ] **Balance pass**: Run `$cgs-balance-check` on progression curve
...
**Related Skills**:
- `$cgs-balance-check` — Validate formulas and progression
- `$cgs-architecture-decision` — Document technical decisions
- `$cgs-code-review` — Ensure code matches clarified design

---

*This document was generated by `$cgs-reverse-document design [path]`*
