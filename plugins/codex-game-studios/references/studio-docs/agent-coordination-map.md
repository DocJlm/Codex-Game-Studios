...
```
1. qa-tester          -- Files bug report with $cgs-bug-report
...
```
1. producer           -- Plans sprint with $cgs-sprint-plan new
2. [All agents]       -- Execute assigned tasks
3. producer           -- Daily status with $cgs-sprint-plan status
...
```
1. producer           -- Runs $cgs-milestone-review
...
2. release-manager      -- Cuts release branch, generates $cgs-release-checklist
...
7. release-manager      -- Generates $cgs-changelog, tags release, creates release notes
...
2. prototyper           -- Scaffolds concept prototype with $cgs-prototype
...
2. prototyper           -- Builds production-quality end-to-end build with $cgs-vertical-slice
