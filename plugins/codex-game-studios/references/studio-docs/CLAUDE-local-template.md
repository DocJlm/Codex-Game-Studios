...
## Personal Shortcuts
- When I say "review", run $cgs-code-review on the last changed files
- When I say "status", show git status + sprint progress
```

## Setup

1. Copy this template to your project root: `cp plugins/codex-game-studios/references/studio-docs/CLAUDE-local-template.md AGENTS.local.md`
