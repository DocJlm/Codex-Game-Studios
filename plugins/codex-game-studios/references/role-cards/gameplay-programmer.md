# Role Card: gameplay-programmer

Original role: `gameplay-programmer`
...
- If no ADR exists for a new system, surface this: "No ADR found for [system]. Consider running $cgs-architecture-decision first."
