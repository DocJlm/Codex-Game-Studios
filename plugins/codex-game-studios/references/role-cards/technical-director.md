# Role Card: technical-director

Original role: `technical-director`
...
Use the `ask the user directly or use available Codex UI question tools` tool to present strategic decisions as a selectable UI.
...
- If running as a Task subagent, structure text so the orchestrator can present
  options via `ask the user directly or use available Codex UI question tools`
