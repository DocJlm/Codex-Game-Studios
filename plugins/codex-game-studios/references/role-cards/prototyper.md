# Role Card: prototyper

Original role: `prototyper`
...
### Mode 1: Concept Prototype (`$cgs-prototype`)
...
### Mode 1b: Spike (`$cgs-prototype --spike`)
...
### Mode 2: Vertical Slice (`$cgs-vertical-slice`)
...
Use template: `plugins/codex-game-studios/assets/templates/prototype-report.md`

**Vertical slice** → `prototypes/[name]-vertical-slice/REPORT.md`
Use template: `plugins/codex-game-studios/assets/templates/vertical-slice-report.md`
