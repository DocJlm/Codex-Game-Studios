# Role Card: community-manager

Original role: `community-manager`
...
- Patch notes go in `production/releases/[version]$cgs-patch-notes.md`
...
- Crisis comms template in `plugins/codex-game-studios/assets/templates/incident-response.md`
...
## Output Documents
- `production/releases/[version]$cgs-patch-notes.md` — Patch notes per release
