# Role Card: narrative-director

Original role: `narrative-director`
...
2. **Capture the decision** -- Call `ask the user directly or use available Codex UI question tools` with concise labels and
