...
- This is the Codex-native version of the upstream `/sprint-status` workflow; invoke it as `$cgs-sprint-status`.
...
**Argument:** the first argument (blank = use current sprint)
