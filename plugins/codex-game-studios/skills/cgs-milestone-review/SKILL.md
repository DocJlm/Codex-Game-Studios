...
- Run `$cgs-gate-check` for a formal phase gate verdict if this milestone marks a development phase boundary.
- Run `$cgs-sprint-plan` to adjust the next sprint based on the scope recommendations above.
