...
<!-- Living document — updated by $cgs-architecture-review after each review run.
...
| TR-[gdd]-002 | [filename] | [system name] | [one-line summary] | — | ❌ GAP | Needs `$cgs-architecture-decision [title]` |
...
**When running `$cgs-architecture-review`**: The skill will update this document
