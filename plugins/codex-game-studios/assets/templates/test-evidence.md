...
All roles must sign off before the story can be marked COMPLETE via `$cgs-story-done`.
...
*Template: `plugins/codex-game-studios/assets/templates/test-evidence.md`*
